...
do
alg=diffpool
for init in ori ori-rowsum ori-standard label label-standard degree-standard uniform deepwalk triangle-standard egonet-standard kcore-standard pagerank-standard
do
