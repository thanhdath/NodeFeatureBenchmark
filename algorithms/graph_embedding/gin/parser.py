...
class Parser():
    ...
    def _parse(self):
        ...
        self.parser.add_argument('--init', type=str, default="ori", help="Features initialization method")
        self.parser.add_argument('--feature_size', type=int, default=128, help="Features dimension")
        self.parser.add_argument('--norm_features', action='store_true', help="norm features by standard scaler.")
        self.parser.add_argument('--verbose', type=int, default=0)
