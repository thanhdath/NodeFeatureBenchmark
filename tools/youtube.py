...
labels = {}
with open('data/youtube/labels.txt') as fp:
    for line in fp:
...
edgelist = []
with open('data/youtube/edgelist.txt') as fp:
    for line in fp:
